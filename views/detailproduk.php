...
<body>
        ...
        <div class="container">
            <div class="detail">
                <div class="wrap-detail">
                    ...
                    <div class="wrapp">
                        <div class="detail-info">
                            ...
                            <h2>Rp <?php echo number_format($barang['harga']); ?></h2>
                        </div>
                        <div class="deskripsi">
                ...
                <div class="comments">
                    ...
                    <div class="user-comment">
                        <img src="../img/tommy2.jpg" alt="User Profile">
                        <div class="comment-details">
                            <h4>Tommy</h4>
                            <p>Barangnya bagus-bagus</p>
                        </div>
                    </div>
                    <div class="user-comment">
                        <img src="../img/cici2.jpg" alt="User Profile">
                        <div class="comment-details">
                            <h4>Rifki</h4>
                            <p>Prosesnya cepat, barangnya berkualitas</p>
                        </div>
                    </div>
                    <div class="user-comment">
                        <img src="../img/abdi2.jpg" alt="User Profile">
                        <div class="comment-details">
                            <h4>Abdi</h4>
                            <p>Beli HP di toko handphone</p>
                            <p>Pelayanannya bikin hati senang</p>
                            <p>Uang kurang seratus, tak masalah</p>
                            <p>Pinjam dulu, persahabatan terjaga</p>
                        </div>
                    </div>
                    <form class="comment-form">
                        ...
                        <textarea id="komentar" name="komentar" class="input" required></textarea>
            ...
            <div class="form-keranjang">
                <form action="" method="post">
                    ...
                    <input type="number" id="quantity" name="quantity" min="1" class="input" required>
                    <button type="submit" name="jumlah">Check Out</button>
                </form>
            </div>
        </div>
    </section>
    <footer>
        <div class="container-footer">
            ...
            <div class="footlogo">
                <a href="#" class="footer-logo">Toko<span>Handphone</span></a>
            </div>
        </div>
    </footer>
    <script >
