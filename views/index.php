<?php
    ...
    $tampil = mysqli_query($conn, "SELECT * FROM hp_form WHERE id IN ($id_string)");
...
<body>
    ...
    <section id="about" class="aboutus reveal">
    ...
    <!-- about section end -->
    <section id="katalog" class="hp reveal">
        <div class="content_hp">
            ...
            <div class="product-content">
                ...
                <a href="produk.php" class="product-card">
                    ...
                    <p class="price">Rp.
                    <?php echo number_format($normal['harga']); ?>
                    </p>
    ...
    <!-- feather icon -->
    <script>
        // Dapatkan path URL saat ini tanpa domain
        var currentPath = window.location.pathname;

        // Dapatkan semua tautan navbar
        var navbarLinks = document.querySelectorAll('.navbar-nav a');

        // Loop melalui setiap tautan
        navbarLinks.forEach(function(link) {
            // Periksa apakah path tautan sesuai dengan path URL saat ini
